...
lpt_options['mask_calc_with_accumulation_period'] = True  # Whether to calculate the mask with accumulation variables. (Ignored if mask_detailed_output is False).
